...
const categoryName = computed(() => {
  ...
  return cat?.name || route.params.slug
})
...
<template>
  <div>
    <header class="mb-10 pt-4">
      <div class="ed-sec-title mb-5">分类</div>
    ...
    <div v-else-if="posts.length === 0" class="text-center py-16 text-ed-muted text-sm">该分类下暂无文章</div>
    <div v-else>
